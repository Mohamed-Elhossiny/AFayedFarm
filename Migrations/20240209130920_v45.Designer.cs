...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AFayedFarm.Model.FridgeRecord", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FridgeRecordID"));
            ...
            modelBuilder.Entity("AFayedFarm.Model.Transaction", b =>
                {
                    ...
                    b.Property<decimal?>("DeliveredToDriver")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal?>("TotalCapcity")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("AFayedFarm.Model.TransactionProduct", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AFayedFarm.Model.ExpenseRecord", b =>
                {
                    ...
                    b.HasOne("AFayedFarm.Model.FridgeRecord", "FridgeProduct")
                        .WithMany("ExpeneseRecordList")
                        .HasForeignKey("FridgeProductID");
